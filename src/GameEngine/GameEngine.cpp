...
GameEngine::GameEngine() {
     ...
     *
     * The assets directory contains all the images, audio, and font files used
     * in the game. The configuration directory contains the configuration file
     * for the game.
     *
...
void GameEngine::sUserInput() {
    ...
    while (SDL_PollEvent(&event)) {
        ...
        if (event.type == SDL_MOUSEBUTTONDOWN ||
             ...
             */
            ActionState const actionState = event.type == SDL_MOUSEBUTTONDOWN
                                                ? ActionState::START
                                                : ActionState::END;
