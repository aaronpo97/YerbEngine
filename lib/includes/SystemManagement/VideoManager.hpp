...
namespace YerbEngine {
    ...
    class VideoManager {
         ...
         *
         * This function sets up the SDL video system by calling SDL_Init with
         ...
         *
         * @throws std::runtime_error If the SDL video subsystem fails to
         * initialize.
         */
         ...
         *
         * Initializes and creates an SDL window using configuration parameters
         * from ConfigManager. Sets various window flags based on the platform
         * and configuration, and handles errors if window creation fails.
         * Calculates the display scale factor for High-DPI (Retina) displays.
         *
      ...
      public:
         ...
         *
         * This function destroys the SDL renderer and window, and quits the SDL
         * video subsystem.
         */
        void cleanup();
