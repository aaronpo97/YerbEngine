...
namespace YerbEngine {
    ...
    void ConfigManagerDeprecated::parseGameConfig() {
        ...
        auto const windowTitle = getJsonValue<std::string>(
            gameConfigJson, "windowTitle", "gameConfig");
    ...
    void ConfigManagerDeprecated::parseItemConfig() {
        ...
        m_itemConfig.shape =
            parseShapeConfig(config["shape"], "itemConfig.shape");
    ...
    void ConfigManagerDeprecated::parseEnemyConfig() {
        ...
        m_enemyConfig.speed =
            getJsonValue<float>(config, "speed", "enemyConfig");
    ...
    void ConfigManagerDeprecated::parseBulletConfig() {
        ...
        m_bulletConfig.speed =
            getJsonValue<float>(config, "speed", "bulletConfig");
    ...
    void ConfigManagerDeprecated::parsePlayerConfig() {
        ...
        if (m_playerConfig.speedBoostMultiplier <= 0 ||
            ...
            throw ConfigurationError(
                "Player speed multipliers must be positive");
        }
    }
    ...
    void ConfigManagerDeprecated::loadConfig() {
        ...
        try {
            ...
            throw ConfigurationError("JSON parse error: " +
                                     std::string(e.what()));
        }
